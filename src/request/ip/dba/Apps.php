<?php
namespace pctco\php\request\ip\dba;
class Apps{
     ...
     public static function find($ip){
          ...
          if ($ipdot[0] < 0 || $ipdot[0] > 255 || count($ipdot) !== 4) return 'N/A';

          if (self::$fp === NULL) self::init();
          ...
          if ($index_offset === NULL) return 'N/A';
     ...
     private static function init(){
          if (self::$fp === NULL){
               ...
               self::$fp = fopen(__DIR__ . '/db.datx', 'rb');
               if (self::$fp === FALSE){
                    throw new Exception('Invalid db.datx file!');
               }
